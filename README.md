...
[![Verified](https://img.shields.io/badge/real%20OpenClaw-v0.2.18%20verified-brightgreen)](#verified-on-real-openclaw)
...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/cost-firewall/v0.2.18/install.sh | bash
